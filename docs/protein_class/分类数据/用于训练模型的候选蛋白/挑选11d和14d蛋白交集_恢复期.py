...
f1 = r'../../../热图/预后/11d_子集_heatmap_proteins.csv'
f2 = r'../../../热图/预后/14d_子集_heatmap_proteins.csv'
f3 = r'../../../热图/急期/7d_交集添加后_heatmap_proteins.csv'
...
protein_list3 = df3.values.flatten().tolist()
protein_list3 = [protein for protein in protein_list3 if pd.notna(protein)]

# 将列表转换为集合
set1 = set(protein_list1)
set2 = set(protein_list2)
set3 = set(protein_list3)
...
intersection_df.to_csv('model33.csv', index=False)
